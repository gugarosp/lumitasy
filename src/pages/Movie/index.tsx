            ...
            ? 
                <section className={`${styles.movie} outer-content-common outer-content-full`}>
                    ...
                    <div className={styles.background}>
                        <img src={`https://lumitasy-resources.vercel.app/images/movies/backgrounds/${movieInfo.slug}.jpg`} alt={movieInfo.title} />
                    </div>

                    <div className={`${styles.logo} content`}>
                        <div className={styles["logo-container"]}>
                            <img src={`https://lumitasy-resources.vercel.app/images/movies/logos/${movieInfo.slug}.png`} alt={movieInfo.title} />
                        </div>
                    </div>
